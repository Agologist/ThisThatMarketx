      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <h2 className="font-racing text-primary text-xl">DataRacer</h2>
          </div>
          ...
          <div className="flex space-x-4">
            <a 
              href="#" 
              className="w-8 h-8 rounded-full bg-card flex items-center justify-center text-muted-foreground hover:text-primary transition-colors"
              aria-label="Twitter"
            >
        ...
        <div className="border-t border-primary/20 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            © {year} DataRacer. All rights reserved.
          </p>
          <div className="flex space-x-4">
